...
### `Prehľad realizovaných experimentov`:

* **Predspracovanie dát:**
    * Implementácia **skeletonizácie** pre redukciu dimenzie a zvýraznenie štruktúry.
* **Dátová príprava:**
    * Agregácia a unifikácia viacerých rôznorodých datasetov do jedného celku.
* **Modelovanie (CNN):**
    * Testovanie rôznych architektúr konvolučných sietí.
    * Ladenie hyperparametrov a konfigurácií modelu.
...
![alt text](obrazky/porovnanie1.png)
![alt text](obrazky/porovnanie2.png)


Ukážka Wandb experimentov: 
Prvé pokusy vlastnej CNN so zmiešanými datasetmi
![alt text](obrazky/WandB_ukazka1.png)
...
![alt text](obrazky/WandB_ukazka2.png)
